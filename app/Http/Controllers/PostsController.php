...
class PostsController extends Controller
{
    ...
    public function __construct(){
        $this->middleware('auth')->except(['index', 'blog.index', 'show']);   
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/blog')->with('message', 'Your post has been sent to overview!');
    }
    ...
    public function update(Request $request, $slug)
    {
        ...
        return redirect('/blog')->with('message', 'Your post has been edited successfully!');
    }
